...
<body>
    <div style="text-align: center;">
      ...
      <hr>
      <br>
      <h1>Halo {{$emailUpdateItem['nama_customer']}}</h1>
      <p style="text-align: justify;"> Yang terhormat Bapak/Ibu customer {{$emailUpdateItem['nama_customer']}}, <br><br>Terima kasih atas kerjasamanya pada project {{$emailUpdateItem['project_name']}}, saya sebagai programmer {{$emailUpdateItem['nama_programmer']}}, melaporkan progres dengan {{$emailUpdateItem['title']}} sebesar {{$emailUpdateItem['presentase']}}% yaitu pada:<br><br><br>
    ...
    <p style="text-align: justify;"> Silahkan cek pada sistem untuk lebih jelas, terimakasih<br><br>
        <p style="text-align: justify;"> Salam hormat, <br><br>
            <p style="text-align: justify;"> {{$emailUpdateItem['nama_programmer']}} <br><br>
                <hr>
